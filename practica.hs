...
tiempoEnParqueadero vehiculo tiempoActual =
    case salida vehiculo of
        Just salidaVehiculo -> diffUTCTime salidaVehiculo (entrada vehiculo)
...
guardarParqueadero parqueadero = do
    resultado <- try $ writeFile "parqueadero.txt" (unlines (map mostrarVehiculo parqueadero))
    case resultado of
        Left ex -> putStrLn $ "Ocurrió un error al guardar el archivo: " ++ show (ex :: IOException)
...
mostrarVehiculo vehiculo =
    ...
    ", Entrada: " ++ show (entrada vehiculo) ++
    ", Salida: " ++ maybe "En parqueadero" show (salida vehiculo)

-- Función para mostrar los autos que están en el parqueadero
mostrarAutosEnParqueadero :: [Vehiculo] -> IO ()
mostrarAutosEnParqueadero parqueadero = do
    putStrLn "Autos en el parqueadero:"
...
cicloPrincipal parqueadero = do
    ...
    putStrLn "4. Mostrar vehículos en el parqueadero"
    putStrLn "5. Salir"
    ...
    case opcion of
        ...
        "4" -> do
            ...
            mostrarAutosEnParqueadero parqueadero
            cicloPrincipal parqueadero
